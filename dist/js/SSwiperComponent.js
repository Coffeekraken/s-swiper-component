  ...
  (function(_SWebComponent) {
    ...
    function SSwiperComponent() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(SSwiperComponent)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      )
      ...
      [
        ...
        },
        {
          ...
          value: function componentWillMount() {
            _get(
              ...
              "componentWillMount",
              this
            ).call(this) // check that the html requirement is fulfilled
        ...
        },
        {
          ...
          value: function componentMount() {
            ...
            this._$swiper.classList.add(
              "".concat(this.componentNameDash, "__swiper")
            )

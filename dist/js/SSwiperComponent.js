...
var _swiper = require("swiper/dist/js/swiper.esm")

var _uniqid = _interopRequireDefault(
  require("coffeekraken-sugar/js/utils/uniqid")
)
  ...
  (function(_SWebComponent) {
    ...
    function SSwiperComponent() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(SSwiperComponent).apply(this, arguments)
      )
    }
      ...
      [
        ...
        },
        {
          ...
          value: function componentWillMount() {
            _get(
              _getPrototypeOf(SSwiperComponent.prototype),
              "componentWillMount",
              this
            ).call(this)
          }
        ...
        },
        {
          ...
          value: function componentMount() {
            _get(
              ...
              "componentMount",
              this
            ).call(this) // get the $swiper element

            this._$swiper = this.querySelector(
              "["
                .concat(this.componentNameDash, "-swiper], [")
                .concat(this.componentNameDash, "]")
              ...
              throw new Error(
                "In order to work, the "
                  .concat(
                    ...
                    ' component need an HTMLElement with the attribute "'
                  )
                  .concat(this.componentNameDash, '-swiper" on it...')
              )
            ...
            Array.from(
              this._$swiper.querySelectorAll(
                "[".concat(this.componentNameDash, "-slide]")
              )
              ...
              _objectSpread(
                {
                  navigation: {
                    nextEl: "#"
                      .concat(id, " [")
                      .concat(this.componentNameDash, "-next]"),
                    prevEl: "#"
                      .concat(id, " [")
                      .concat(this.componentNameDash, "-prev], #")
                      .concat(id, " [")
                      .concat(this.componentNameDash, "-previous]")
                  },
                  pagination: {
                    el: "#"
                      .concat(id, " [")
                      .concat(this.componentNameDash, "-pagination]"),
                    type: "bullets",
                    bulletElement: "li",
                    clickable: true,
                    dynamicBullets: true,
        ...
        },
        {
          ...
          value: function componentUnmount() {
            _get(
              ...
              "componentUnmount",
              this
            ).call(this) // destroy swiper instance
        ...
        },
        {
          ...
          value: function _proxyEvents(events) {
            ...
            events.forEach(function(event) {
              _this.swiper.on(event, function() {
                ;(0, _dispatchEvent.default)(_this, event)
              })
            })
          }
        }
